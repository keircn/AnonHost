        ...
        <section className="w-full pt-12 md:pt-12 md:pb-24 lg:pt-16 lg:pb-16">
          <div className="container px-4 mt-[15vh] mb-36 md:px-6">
            <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              ...
              >
                <div className="bg-gradient-to-br from-purple-500 to-indigo-700 w-full h-full flex items-center justify-center">
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12">
              ...
              >
                ...
                <p className="text-gray-500 dark:text-gray-400">Drag and drop or select files to upload instantly</p>
              </motion.div>
              <motion.div
                className="grid gap-1"
                initial={{ opacity: 0, y: 20 }}
