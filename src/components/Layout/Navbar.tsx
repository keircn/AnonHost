    ...
    <header className="sticky top-0 z-50 w-full border-b-2 border-border bg-background">
      <div className="container mx-auto flex h-16 max-w-7xl items-center px-4 xl:px-8 2xl:px-16">
        <div className="flex items-center gap-6 lg:gap-8">
          <Link href="/" className="-ml-2 flex items-center gap-2 border border-transparent px-2 py-1.5 transition-colors hover:border-border hover:bg-secondary">
            <Logo variant="image" size="sm" />
            <span className="text-sm font-bold transition-colors lg:text-base">
              AnonHost
            </span>
          </Link>

          <nav className="retro-inset hidden items-center bg-secondary/50 p-1 md:flex">
            <NavigationLinks />
          </nav>
        </div>
