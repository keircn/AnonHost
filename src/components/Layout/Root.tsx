              ...
              <div className="relative flex min-h-screen min-w-0 flex-col overflow-x-hidden">
                ...
                <footer className="w-full border-t px-4 py-4 sm:px-6 lg:px-8">
                  <div className="mx-auto flex w-full max-w-7xl items-center justify-center gap-4 text-xs text-muted-foreground">
                    ...
                    <a href="https://discord.gg/JSbsgaehFd" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">Support</a>
                    <a href="https://github.com/keircn/AnonHost" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">GitHub</a>
                  </div>
                </footer>
              </div>
            </NavbarProvider>
