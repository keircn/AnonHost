...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-card text-card-foreground flex flex-col gap-4 border-2 border-t-white border-l-white border-r-zinc-700 border-b-zinc-700 py-4 shadow-[inset_1px_1px_0_#dfdfdf,inset_-1px_-1px_0_#808080]",
        className,
      )}
      {...props}
    />
